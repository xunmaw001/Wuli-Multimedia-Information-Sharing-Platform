<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":" 30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="作品分类" prop="zuopinfenlei">
					<el-input v-model="ruleForm.zuopinfenlei" placeholder="作品分类" clearable  :readonly="ro.zuopinfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="作品分类" prop="zuopinfenlei">
