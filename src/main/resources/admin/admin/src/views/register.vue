<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220730/f8a94381f96c4e64a8955d168317078c.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='security1'" :style='{"padding":"20px 30px","boxShadow":"0px 4px 10px 0px #A29988","margin":"0 0 0 -480px","borderRadius":"10px","background":"#fff","width":"450px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px","margin":"0 0 15px 0","color":"#333","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"23px","fontWeight":"600","height":"auto"}' class="title">武理多媒体信息共享平台开发找回密码</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 10px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(193, 44, 44, 1)","display":"block","width":"80%","fontSize":"16px","height":"44px"}' type="button" class="r-btn" @click="getSecurity()">下一步</button>
			...
			<el-form v-if="pageFlag=='security2'" :style='{"padding":"20px 30px","boxShadow":"0px 4px 10px 0px #A29988","margin":"0 0 0 -480px","borderRadius":"10px","background":"#fff","width":"450px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px","margin":"0 0 15px 0","color":"#333","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"23px","fontWeight":"600","height":"auto"}' class="title">武理多媒体信息共享平台开发密码重置</div>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item">
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 10px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(193, 44, 44, 1)","display":"block","width":"80%","fontSize":"16px","height":"44px"}' type="button" class="r-btn" @click="validateSecurity()">下一步</button>
				<div :style='{"cursor":"pointer","padding":"0 10%","color":"rgba(159, 159, 159, 1)","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"underline"}' class="r-login" @click="close()">已有账号，直接登录</div>
            </el-form>
			<el-form v-if="pageFlag=='security3'" :style='{"padding":"20px 30px","boxShadow":"0px 4px 10px 0px #A29988","margin":"0 0 0 -480px","borderRadius":"10px","background":"#fff","width":"450px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px","margin":"0 0 15px 0","color":"#333","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"23px","fontWeight":"600","height":"auto"}' class="title">武理多媒体信息共享平台开发密码重置</div>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item">
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 10px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(193, 44, 44, 1)","display":"block","width":"80%","fontSize":"16px","height":"44px"}' type="button" class="r-btn" @click="updatePassword()">修改密码</button>
				<div :style='{"cursor":"pointer","padding":"0 10%","color":"rgba(159, 159, 159, 1)","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"underline"}' class="r-login" @click="close()">已有账号，直接登录</div>
            </el-form>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"20px 30px","boxShadow":"0px 4px 10px 0px #A29988","margin":"0 0 0 -480px","borderRadius":"10px","background":"#fff","width":"450px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px","margin":"0 0 15px 0","color":"#333","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"23px","fontWeight":"600","height":"auto"}' class="title">武理多媒体信息共享平台开发注册</div>
