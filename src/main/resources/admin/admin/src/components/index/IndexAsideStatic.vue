<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"10px 0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: rgba(162, 153, 136, 1);
						background: linear-gradient(180deg, #A29988 0%, rgba(162,153,136,0.7877) 26%, rgba(255,255,255,0.4500) 26%, #FFFFFF 49%, rgba(255,255,255,0.6200) 74%, #A29988 76%, #A29988 100%);
					}
