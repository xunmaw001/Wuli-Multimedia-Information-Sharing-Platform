	...
	<div class="detail-preview" :style='{"margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"minHeight":"500px","width":"41%","padding":"20px 0","margin":"0 7% 0 0","background":"none"}'>
				...
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>私聊账号</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.siliaozhanghao}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>私聊姓名</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.siliaoxingming}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>私聊日期</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.siliaoriqi}}</div>
				</div>
		...
		<el-tabs class="detail" :style='{"border":"0px solid #DCDFE6","boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","margin":"60px 7% 0","background":"none","flex":"1","width":"50%","float":"left"}' v-model="activeName" type="border-card">
			<el-tab-pane label="私聊内容" name="first">
				<div v-html="detail.siliaoneirong"></div>
			</el-tab-pane>
		</el-tabs>
	</div>
</div>
