    ...
    <el-tabs tab-position="left" :style='{"width":"100%","background":"none"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="150px">
          ...
          <el-form-item :style='{"width":"100%","padding":"2px 10px","margin":"0 0 20px 0","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)"}' v-if="userTableName=='yonghu'" label="密保问题" prop="pquestion">
            <el-input v-model="sessionForm.pquestion" placeholder="密保问题" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"2px 10px","margin":"0 0 20px 0","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)"}' v-if="userTableName=='yonghu'" label="密保答案" prop="panswer">
    ...
    created() {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'zhanghao', [{ required: true, message: '请输入账号', trigger: 'blur' }]);
			...
			if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'zhanghao', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
      }
      if ('yonghu' == this.userTableName) {
